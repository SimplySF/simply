...
Shared HTML report scaffolding for SimplySF Salesforce CLI plugins. This package is part of the [`simply-node`](https://github.com/SimplySF/simply-node) monorepo.
